...
export const connectDB = async () => {
  await mongoose
    .connect(
      "mongodb://simransaini5869_db_user:mvypW6znodS5czrI@ac-yyeihik-shard-00-00.ci7ofnc.mongodb.net:27017,ac-yyeihik-shard-00-01.ci7ofnc.mongodb.net:27017,ac-yyeihik-shard-00-02.ci7ofnc.mongodb.net:27017/devTinder?ssl=true&replicaSet=atlas-10e2cv-shard-0&authSource=admin&appName=Cluster0"
    )
    .then(() => {
